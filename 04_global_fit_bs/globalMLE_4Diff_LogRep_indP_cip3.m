...
function globalMLE_4Diff_LogRep_indP_cip3()
    ...
    cond2_1=load([path 'results_cip3\cip3_010_1.mat'],'arrD');
    cond2_2=load([path 'results_cip3\cip3_010_2.mat'],'arrD');
    cond2_3=load([path 'results_cip3\cip3_010_3.mat'],'arrD');
    ...
    cond3_1=load([path 'results_cip3\cip3_025_1.mat'],'arrD');
    cond3_2=load([path 'results_cip3\cip3_025_2.mat'],'arrD');
    cond3_3=load([path 'results_cip3\cip3_025_3.mat'],'arrD');    
    ...
    cond4_1=load([path 'results_cip3\cip3_045_1.mat'],'arrD');
    cond4_2=load([path 'results_cip3\cip3_045_2.mat'],'arrD');
    cond4_3=load([path 'results_cip3\cip3_045_3.mat'],'arrD');    
    cond4_4=load([path 'results_cip3\cip3_045_4.mat'],'arrD');    
    
    cond{4,1}=cond4_1.arrD;
    cond{4,2}=cond4_2.arrD;
    cond{4,3}=cond4_3.arrD;    
    cond{4,4}=cond4_4.arrD;    
    numSub{4}=4;

    cond5_1=load([path 'results_cip3\cip3_060_1.mat'],'arrD');
    cond5_2=load([path 'results_cip3\cip3_060_2.mat'],'arrD');
    cond5_3=load([path 'results_cip3\cip3_060_3.mat'],'arrD');    
    ...
    cond6_1=load([path 'results_cip3\cip3_090_1.mat'],'arrD');
    cond6_2=load([path 'results_cip3\cip3_090_2.mat'],'arrD');
    cond6_3=load([path 'results_cip3\cip3_090_3.mat'],'arrD');    
    cond6_4=load([path 'results_cip3\cip3_090_4.mat'],'arrD');    
    cond6_5=load([path 'results_cip3\cip3_090_5.mat'],'arrD');    
    ...
    cond7_1=load([path 'results_cip3\cip3_120_1.mat'],'arrD');
    cond7_2=load([path 'results_cip3\cip3_120_2.mat'],'arrD');
    cond7_3=load([path 'results_cip3\cip3_120_3.mat'],'arrD');    
    cond7_4=load([path 'results_cip3\cip3_120_4.mat'],'arrD');    
    ...
    cond8_1=load([path 'results_cip3\cip3_180_1.mat'],'arrD');
    cond8_2=load([path 'results_cip3\cip3_180_2.mat'],'arrD');
    cond8_3=load([path 'results_cip3\cip3_180_3.mat'],'arrD');    
