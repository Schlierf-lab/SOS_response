function globalMLE_4Diff_LogRep_indP_mutants()
    ...
    boolShow=0; % show fit result
    numbins=90; % number of histogram bins
    cond_x=[0 10 20 30 40 50 60 70]; % x-Axis of conditions
    ...
    cond2_1=load([path 'results_S119A\cip00_000_1.mat'],'arrD');
    cond2_2=load([path 'results_S119A\cip00_000_2.mat'],'arrD');
    cond2_3=load([path 'results_S119A\cip00_000_3.mat'],'arrD');
    cond2_4=load([path 'results_S119A\cip00_000_4.mat'],'arrD');   
    ...
    cond3_1=load([path 'results_E45K\cip00_000_1.mat'],'arrD');
    cond3_2=load([path 'results_E45K\cip00_000_2.mat'],'arrD');
    cond3_3=load([path 'results_E45K\cip00_000_3.mat'],'arrD');
    ...
    cond4_1=load([path 'results_R28A_N41A_E45K\cip00_000_1.mat'],'arrD');
    cond4_2=load([path 'results_R28A_N41A_E45K\cip00_000_2.mat'],'arrD');
    cond4_3=load([path 'results_R28A_N41A_E45K\cip00_000_3.mat'],'arrD');   
    ...
    cond5_1=load([path 'results_cip20\cip20_045_1.mat'],'arrD');
    cond5_2=load([path 'results_cip20\cip20_045_2.mat'],'arrD');
    cond5_3=load([path 'results_cip20\cip20_045_3.mat'],'arrD');
    ...
    cond6_1=load([path 'results_S119A\cip20_045_1.mat'],'arrD');
    cond6_2=load([path 'results_S119A\cip20_045_2.mat'],'arrD');
    cond6_3=load([path 'results_S119A\cip20_045_3.mat'],'arrD');
    ...
    cond7_1=load([path 'results_E45K\cip20_025_1.mat'],'arrD');
    cond7_2=load([path 'results_E45K\cip20_025_2.mat'],'arrD');
    cond7_3=load([path 'results_E45K\cip20_025_3.mat'],'arrD');
    ...
    cond8_1=load([path 'results_R28A_N41A_E45K\cip20_025_1.mat'],'arrD');
    cond8_2=load([path 'results_R28A_N41A_E45K\cip20_025_2.mat'],'arrD');
    cond8_3=load([path 'results_R28A_N41A_E45K\cip20_025_3.mat'],'arrD');
