...
function globalMLE_4Diff_LogRep_indP_S119A()
    ...
    cond_x=[0 10 25 45 60 90 120]; % x-Axis of conditions
    ...
    %% load data   
    cond1_1=load([path 'results_S119A\cip00_000_1.mat'],'arrD');
    cond1_2=load([path 'results_S119A\cip00_000_2.mat'],'arrD');
    cond1_3=load([path 'results_S119A\cip00_000_3.mat'],'arrD');
    cond1_4=load([path 'results_S119A\cip00_000_4.mat'],'arrD');
    ...
    cond2_1=load([path 'results_S119A\cip20_010_1.mat'],'arrD');
    cond2_2=load([path 'results_S119A\cip20_010_2.mat'],'arrD');
    cond2_3=load([path 'results_S119A\cip20_010_3.mat'],'arrD');
    ...
    cond3_1=load([path 'results_S119A\cip20_025_1.mat'],'arrD');
    cond3_2=load([path 'results_S119A\cip20_025_2.mat'],'arrD');
    cond3_3=load([path 'results_S119A\cip20_025_3.mat'],'arrD');
    cond3_4=load([path 'results_S119A\cip20_025_4.mat'],'arrD');
    cond3_5=load([path 'results_S119A\cip20_025_5.mat'],'arrD');
    cond3_6=load([path 'results_S119A\cip20_025_6.mat'],'arrD');
    
    cond{3,1}=cond3_1.arrD;
    cond{3,2}=cond3_2.arrD;
    cond{3,3}=cond3_3.arrD;
    cond{3,4}=cond3_4.arrD;
    cond{3,5}=cond3_5.arrD;
    cond{3,6}=cond3_6.arrD;
    numSub{3}=6;

    cond4_1=load([path 'results_S119A\cip20_045_1.mat'],'arrD');
    cond4_2=load([path 'results_S119A\cip20_045_2.mat'],'arrD');
    cond4_3=load([path 'results_S119A\cip20_045_3.mat'],'arrD');    
    ...
    cond5_1=load([path 'results_S119A\cip20_060_1.mat'],'arrD');
    cond5_2=load([path 'results_S119A\cip20_060_2.mat'],'arrD');
    cond5_3=load([path 'results_S119A\cip20_060_3.mat'],'arrD');    
    ...
    cond6_1=load([path 'results_S119A\cip20_090_1.mat'],'arrD');
    cond6_2=load([path 'results_S119A\cip20_090_2.mat'],'arrD');
    cond6_3=load([path 'results_S119A\cip20_090_3.mat'],'arrD');    
    ...
    cond7_1=load([path 'results_S119A\cip20_120_1.mat'],'arrD');
    cond7_2=load([path 'results_S119A\cip20_120_2.mat'],'arrD');
    cond7_3=load([path 'results_S119A\cip20_120_3.mat'],'arrD');    
