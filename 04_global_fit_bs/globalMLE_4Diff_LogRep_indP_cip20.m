function globalMLE_4Diff_LogRep_indP_cip0p5_NEW()
    ...
    cond2_1=load([path 'results_cip20\cip20_010_1.mat'],'arrD');
    cond2_2=load([path 'results_cip20\cip20_010_2.mat'],'arrD');
    cond2_3=load([path 'results_cip20\cip20_010_3.mat'],'arrD');
    ...
    cond3_1=load([path 'results_cip20\cip20_025_1.mat'],'arrD');
    cond3_2=load([path 'results_cip20\cip20_025_2.mat'],'arrD');
    cond3_3=load([path 'results_cip20\cip20_025_3.mat'],'arrD');    
    cond3_4=load([path 'results_cip20\cip20_025_4.mat'],'arrD');
    ...
    cond4_1=load([path 'results_cip20\cip20_045_1.mat'],'arrD');
    cond4_2=load([path 'results_cip20\cip20_045_2.mat'],'arrD');
    cond4_3=load([path 'results_cip20\cip20_045_3.mat'],'arrD');    
    ...
    cond5_1=load([path 'results_cip20\cip20_060_1.mat'],'arrD');
    cond5_2=load([path 'results_cip20\cip20_060_2.mat'],'arrD');
    cond5_3=load([path 'results_cip20\cip20_060_3.mat'],'arrD');    
    ...
    cond6_1=load([path 'results_cip20\cip20_090_1.mat'],'arrD');
    cond6_2=load([path 'results_cip20\cip20_090_2.mat'],'arrD');
    cond6_3=load([path 'results_cip20\cip20_090_3.mat'],'arrD');    
    cond6_4=load([path 'results_cip20\cip20_090_4.mat'],'arrD');    
    cond6_5=load([path 'results_cip20\cip20_090_5.mat'],'arrD');    
    
    cond{6,1}=cond6_1.arrD;
    cond{6,2}=cond6_2.arrD;
    cond{6,3}=cond6_3.arrD;    
    cond{6,4}=cond6_4.arrD;
    cond{6,5}=cond6_5.arrD;
    numSub{6}=5;
    
    cond7_1=load([path 'results_cip20\cip20_120_1.mat'],'arrD');
    cond7_2=load([path 'results_cip20\cip20_120_2.mat'],'arrD');
    cond7_3=load([path 'results_cip20\cip20_120_3.mat'],'arrD');    
    cond7_4=load([path 'results_cip20\cip20_120_4.mat'],'arrD');    
    
    cond{7,1}=cond7_1.arrD;
    cond{7,2}=cond7_2.arrD;
    cond{7,3}=cond7_3.arrD;    
    cond{7,4}=cond7_4.arrD;
    numSub{7}=4;
    
    cond8_1=load([path 'results_cip20\cip20_180_1.mat'],'arrD');
    cond8_2=load([path 'results_cip20\cip20_180_2.mat'],'arrD');
    cond8_3=load([path 'results_cip20\cip20_180_3.mat'],'arrD');    
