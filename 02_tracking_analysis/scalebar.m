...
%  - added unit string
    ...
    linepos_l = (linepos(2,1)+linepos(1,1))/2;
    linepos_r = (linepos(2,2)+linepos(1,2))/2;
%     text(linepos(2,1),linepos(2,2),0,[num2str(scalelength*um_px, '%.1f') unitstring],'verticalalignment',textalignment{1},'horizontalalignment',textalignment{2}, 'color', colour, 'fontweight', fontweight, 'parent', hg);
    text(linepos_l,linepos_r,0,[num2str(scalelength*um_px, '%.1f') unitstring],'verticalalignment',textalignment{1},'horizontalalignment',textalignment{2}, 'color', colour, 'fontweight', fontweight, 'parent', hg);
