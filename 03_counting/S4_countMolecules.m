...
%% parameters
[FILE,PATH]=uigetfile('*.loc.txt','Localization File');
...
% parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cellborders_unCorr=matfile([PATH FILE(1:end-20) 'out.mat']);
cellborders_Corr=matfile([PATH FILE(1:end-20) 'out_corr.mat']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save([PATH FILE(1:end-20) 'Count.mat'],'countArr');
